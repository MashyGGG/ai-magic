...
import { Typography, Card, Form, Input, Select, InputNumber, Button, App, Skeleton, Divider } from 'antd';
...
export default function SettingsPage() {
  ...
  return (
    <div>
      ...
      <Form form={form} layout="vertical" onFinish={(v) => saveMutation.mutate(v)} className="max-w-2xl">
        ...
        <Button type="primary" htmlType="submit" icon={<SaveOutlined />} size="large" loading={saveMutation.isPending}>
          保存设置
        </Button>
      </Form>
    </div>
